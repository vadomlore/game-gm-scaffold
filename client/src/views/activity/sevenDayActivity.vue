<template>
  <div class="app-container calendar-list-container">  
    <el-form label-width="100px" :model="ruleForm" :rules="rules" ref="ruleForm">
        ...
        <sevenDayParamsViewer @sendSevenDayParams="sevenParams"> </sevenDayParamsViewer>
         <el-form-item>
...
<script>
import sevenDayParamsViewer from '@/views/activity/sevenDayParamsViewer.vue'
import accessory from '@/views/email/accessory.vue'
...
export default {
  name: 'sevenDayActivity',
  components: {
    sevenDayParamsViewer,
    accessory
  },
  directives: {
    waves
